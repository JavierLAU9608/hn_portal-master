...
<body class=\"menu-always-on-top-header\">
    ...
    ";
        // line 352
        $this->loadTemplate("administracion/login.twig", "base.twig", 352)->display($context);
        // line 353
        echo "    ";
        $this->loadTemplate("administracion/registro.twig", "base.twig", 353)->display($context);
        // line 354
        echo "    ";
        $this->loadTemplate("administracion/contacto.twig", "base.twig", 354)->display($context);
        // line 355
        echo "
    ";
        // line 356
        $this->loadTemplate("mensaje.twig", "base.twig", 356)->display($context);
        // line 357
        echo "
...
\t&noscript=1\"/>
    ...
    ";
        ...
        if (($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "env", array()) == "development")) {
            // line 471
            echo "        ";
            $this->loadTemplate("@myprofiler/bar/bar.twig", "base.twig", 471)->display($context);
            // line 472
            echo "    ";
        }
        // line 473
