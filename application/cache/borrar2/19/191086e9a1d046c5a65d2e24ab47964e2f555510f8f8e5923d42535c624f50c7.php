...
";
    ...
    <script>
        ...
        \$(document).ready(function () {
            var config = {closedDates: ";
        // line 599
        echo $this->getAttribute((isset($context["room_info"]) ? $context["room_info"] : null), "paros", array());
        echo "};
            config.dateOptions = {
                language: '";
        // line 601
