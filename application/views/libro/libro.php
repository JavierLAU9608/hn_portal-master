...
<head>
<title>Libro</title>
<base href="<?php print base_url('images/libro/'.$idioma); ?>/"/>
<script src="<?php print base_url(); ?>javascript/libro/AC_RunActiveContent.js" type="text/javascript"></script>
<script src="<?php print base_url(); ?>javascript/libro/PopUpWin.js" type="text/javascript"></script>
<style type="text/css">
<!--
body {
