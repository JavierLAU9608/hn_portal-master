...
imagecopymerge($img,$img_2,(200 - 10 - $largo_2),$y,0,0,$largo_2,$ancho_2,100);

$linea_inicial = $y;
if($pagina['titulo']!=='' &&  $pagina['titulo']!==NULL)
{
	imagestring($img,3,200,$linea_inicial,utf8_decode($pagina['titulo']),0xFFBA00);
	$linea_inicial+=20;
}
$lineas = app_word_wrap(utf8_decode($pagina['texto']),7);
foreach($lineas as $linea)
{
	imagestring($img,2,200,$linea_inicial,$linea,0xFFFFFF);
	$linea_inicial+=12;
}
