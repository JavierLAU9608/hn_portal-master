...
nombre = plantilla 4
medias = 2
archivos = array(1=>array('nombre'=>'2','w'=>100,'h'=>150),2=>array('nombre'=>'1','w'=>360,'h'=>260))
*/
...
imagecopymerge($img,$img_1,60,60,0,0,$largo_1,$ancho_1,100);

$linea_inicial = 60;
if($pagina['titulo']!=='' &&  $pagina['titulo']!==NULL)
{
	imagestring($img,3,240,$linea_inicial,utf8_decode($pagina['titulo']),0xFFBA00);
	$linea_inicial+=20;
}
$lineas = app_word_wrap(utf8_decode($pagina['texto']),6);
foreach($lineas as $linea)
{
	imagestring($img,2,240,$linea_inicial,$linea,0xFFFFFF);
	$linea_inicial+=12;
}
...
imagecopymerge($img,$img_2,($largo_fondo - $largo_2)/2,$y,0,0,$largo_2,$ancho_2,100);
