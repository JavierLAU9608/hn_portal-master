    ...
    <div style="position: relative; float: left; width: 650px; border: #e0e0e0 1px solid; background-color: #ffffff;">
        <div style="width: 630px; height: auto; margin-left: 10px;">
            ...
            <div style="clear:both" class="principal">
                ...
                <br/>
                <p style="line-height: 16px; padding: 0; margin: 0;"><span style="color:#ff0f3b;"><b><?php print trans('mail_msg_pago_pasarela_error_part1') ?></b></span> <?php print trans('mail_msg_pago_pasarela_error_part2') ?></p>
                <br/>
<!--                <p>--><?php //echo trans('mail_usar_otra_tarjeta') ?><!-- <a href="--><?php //echo base_url('invitacion-pago-denegado/'.$transaccion) ?><!--">--><?php //echo trans('mail_click_to_pay') ?><!--</a></p>-->
            </div>
