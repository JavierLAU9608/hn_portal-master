    <div style=" background-color: #f6f6f6; padding: 0; font-family: 'Trebuchet MS'; font-size: 12px;margin: 0 auto; width: 650px;">
        <div style="position: relative; float: left; width: 650px; border: #e0e0e0 1px solid; background-color: #ffffff;">
            <div style="width: 630px; height: auto; margin-left: 10px;">
              ...
              <br/>
              <p style="line-height: 16px; padding: 0; margin: 0;"><?php print trans('mail_msg_reservacion_cancelada')?></p>
              </div>
              <div style="border-top:#9B9B9B 20px !important;">
              <br/>
                <p style="line-height: 16px; padding: 0; margin: 0;">
                <?php print trans('reserva_estado')?>: <?php print trans('reserva_estado_cancelada')?>
                <br/>
             ...
             <?php print trans('titular_tarjeta_credito')?>: {titualar_tarjeta}
                ...
                <br/>
                <p style="line-height: 16px; padding: 0; margin: 0;">
                <b><?php print trans('reserva_politica_cancelacion_aplicada'); ?>:</b>
                <br/>
                <?php print trans('reserva_descuento_cancelacion'); ?>: {descuento}
                <br/>
                <?php print trans('reserva_reintegro_cancelacion'); ?>: {reintegro}
                </p>
                <br/>
                <p style="line-height: 16px; padding: 0; margin: 0;">
                <div style="width:90% !important;border:1px solid #000;margin-left:2.5%;padding-left:5%;">                
                 ...
                 <div style="margin-top:20px !important;color:#900;margin-bottom:10px !important;border:2px solid #000;width:92.5%;padding:5px;text-align:center;font-weight:bold;">                 
                 <?php print trans('mail_importe_total')?>: <font>{importe_reserva}</font>
                 </div>
                </div>                
                </p>
              </div>
