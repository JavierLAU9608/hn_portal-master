        ...
        <div style="position: relative; float: left; width: 650px; border: #e0e0e0 1px solid; background-color: #ffffff;">
            <div style="width: 630px; height: auto; margin: 10px;">
              <div class="encabezado">
               ...
               <span style="color:#457FBD; font-size:20px;font-weight:bold;padding-top:100px;"><?php print trans('mail_asunto_usuario_creado') ?>.</span>
              </div>
              ...
              <p>
              <?php print trans('mail_msg_usuario_creado') ?>
              <br/>
              <a href="{link_activacion}">{link_activacion}</a>
              </p>
              </div>
              ...
              <br/>
              <?php print trans('mail_contrasena') ?>: {password}
              <br/>
              <br/>
